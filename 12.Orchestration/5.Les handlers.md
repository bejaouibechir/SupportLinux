Parfait 👍 on va attaquer **les Handlers Ansible**.  
...
- Le `notify` se déclenche uniquement si la tâche s’exécute ET fait un changement.
...
- Pour factoriser, utilisez un rôle avec `handlers/main.yml`.
